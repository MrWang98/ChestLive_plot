...
animals=['1','2','3','4','5']
fig = go.Figure(data=[
    go.Bar(name='Victim1', x=animals, y=[2.50,1.25,1.21,0.68,2.08],marker_color='rgba(247,183,112,1)',width=0.27),
    go.Bar(name='Victim2', x=animals, y=[0.77,0.69,1.59,0.37,1.04],marker_color='rgba(187,189,191,1)',width=0.27),
    go.Bar(name='Victim3', x=animals, y=[2.07,1.41,0.92,2.7,1.91],marker_color='rgba(233,155,122,1)',width=0.27),
])
# Change the bar mode
